...
<p align="center">
  <a href="https://claude.cn/">
    <img src="docs/images/sponsor-claude-cn.png" alt="claude.cn" height="110">
  </a>
</p>
<p align="center">
  <a href="https://claude.cn/"><strong>claude.cn｜OneRouter API 网关</strong></a><br>
  claude.cn 提供 OneRouter 大模型 API 网关，兼容 OpenAI 接口，支持 OpenAI、Anthropic、Google、DeepSeek 等主流模型统一接入，适合日常开发、团队协作和长期项目工作流。
</p>
...
<table>
  ...
  <tr>
    <td align="center">
      <a href="https://claude.cn/">
        <img src="docs/images/sponsor-claude-cn.png" alt="claude.cn" height="80">
      </a>
    </td>
    <td><a href="https://claude.cn/"><strong>claude.cn｜OneRouter API 网关</strong></a><br>感谢 claude.cn 对本项目的支持。claude.cn 提供 OneRouter 大模型 API 网关，兼容 OpenAI 接口，支持 OpenAI、Anthropic、Google、DeepSeek 等主流模型统一接入，适合日常开发、快速配置、团队协作和长期使用。</td>
  </tr>
  <tr>
    <td align="center">
